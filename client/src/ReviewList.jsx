...
class ReviewList extends React.Component {
  ...
  fetchReviews() {
    axios.get('/api/reviews')
      .then((result) => {
        console.log('reviews got again? ', result);
        this.setState({ reviews: result.data });
      })
      .catch(err => console.error(err));
  }
        ...
        <li className={styles.singleReview} key={index}>
          ...
          <div className={styles.userData}>
            ...
            <div className={styles.userStats}>
              ...
              <a className={styles.userName} href="https://www.yelp.com/">
{review.user.name}
</a>
...
<FontAwesomeIcon icon="user-friends" color="#F15C00"/> 
{' '}
<b>{review.user.friends}</b>
{' '}
friends
</div>
              <div className="user-review-number">
<FontAwesomeIcon icon="star" color="#F15C00"/> 
{' '}
<b>{review.user.reviews}</b>
{' '}
reviews
</div>
              <div className="user-photo-number">
<FontAwesomeIcon icon="camera" color="#F15C00"/> 
{' '}
<b>{review.user.photos}</b>
{' '}
photos
</div>
...
<b>Was this review ...?</b>
              ...
              <br />
<br/>
              <button className={styles.usefulButton} onClick={() => this.increaseUsefulVotes(review)}>
...
{' '}
{'  '}
              <button className={styles.funnyButton} onClick={() => this.increaseFunnyVotes(review)}>
...
{' '}
{'  '}
              <button className={styles.coolButton} onClick={() => this.increaseCoolVotes(review)}>
...
<hr className={styles.reviewDivider} />
    ...
    return (
      <div className={styles.reviewEntireSection}>
        <h2>
<font color="#d32323">Recommended Reviews </font>
for
{' '}
...
<FontAwesomeIcon icon="search" color="#eee"/>
</button> 
{' '}
{'  '}
...
{this.state.reviews.length}
        ...
        Page 1 of
{' '}
{Math.ceil(this.state.reviews.length / 10)}
